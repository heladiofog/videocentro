...
class Pelicula_Controller {
	...
	function __construct() {
		...
		foreach ($peticiones as $peticion) {
			...
			if( strpos($uri, $uri_peticion) == true ) {
				...
				//echo $uri, "(URI) - ", $uri_peticion, " (URIPETICION) -- Event final> ", $this->accion, " -- params> ";
			}
		}
		//echo "Event : ", $this->accion, " -- ";
		//echo "/*", $uri,"(construct)*/  Event final> ", $this->accion, " ";
	...
	public function get_pelicula($id) {
		...
		//echo $data['pelicula']->get_tituloVc();
		$this->data['mensaje'] = $pelicula->mensaje_db;
	...
	public function buscar_pelicula($datos_request) {
		...
		/*foreach($this->data['peliculas'] as $p) {
        echo $p ['tituloVc'].' ';
        echo $p ['directorVc'].'<br/>';
    }
		*/
		$this->data['mensaje'] = $pelicula->mensaje_db;
	...
	public function list_all() {
		...
		$pelicula = new Pelicula();
		$this->data['peliculas'] = $pelicula->list_items();
		/*
		foreach($this->data['peliculas'] as $p) {
        echo $p ['tituloVc'].' ';
        echo $p ['directorVc'].'<br/>';
	...
	public function cargar_vista($vista, $data=array()) {
		//require_once('../vista/peliculas/'.$vista.'.php');
	...
	public function saludo() {
		//echo "***Hola tarola. ", $_SERVER['REQUEST_URI'];
		$this->data['submodulo'] = VIEW_LIST_ALL;
		$this->data['subtitulo'] = 'Saludo';
		//$this->data['resultados'] = 'vacio';
		
		$this->cargar_vista('listar', $this->data);
	}
} 
?>