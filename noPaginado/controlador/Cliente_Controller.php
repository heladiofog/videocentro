...
class Cliente_Controller {
	...
	public function get_cliente($id) {
		...
		//echo $data['cliente']->get_nombreVc();
		$this->data['mensaje'] = $cliente->mensaje_db;
	...
	public function buscar_cliente($datos_request) {
		...
		/*foreach($this->data['clientes'] as $cli) {
        echo $p ['nombreVc'].' ';
        echo $p ['emailVc'].'<br/>';
    }
		*/
	...
	public function list_all() {
		...
		$cliente = new Cliente();
		$this->data['clientes'] = $cliente->list_items();
		/*
		foreach($this->data['clientes'] as $cli) {
        echo $p ['nombreVc'].' ';
        echo $p ['emailVc'].'<br/>';
	...
	public function cargar_vista($vista, $data=array()) {
		//require_once('../vista/clientes/'.$vista.'.php');
